  ...
  return (
    <div style={{ padding: '40px' }}>
      <div style={{
        ...
        <FiBriefcase size={28} color="#00ff88" />
        <h1 style={{
          color: '#00ff88',
          fontSize: '28px',
          fontWeight: '700',
      ...
      <div style={{
        ...
        <h3 style={{ color: '#00ff88', marginBottom: '16px' }}>Top Products Queried</h3>
        <p style={{ color: '#ccc' }}>No data available. Commercial campaigns have not been executed yet.</p>
      </div>
    </div>
  );
};
